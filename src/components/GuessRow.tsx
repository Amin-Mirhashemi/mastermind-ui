    ...
    <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
      ...
      <div className="flex gap-1">
        ...
        {Array.from({ length: whitePegs }, (_, i) => (
          <div
            key={`white-${i}`}
            className="w-4 h-4 rounded-full bg-gray-300 dark:bg-slate-300 border border-gray-600 dark:border-black dark:border-gray-400 flex items-center justify-center"
